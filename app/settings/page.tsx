...
function SettingsPageContent() {
  ...
  //       // If they're already on a paid plan, don't cancel — just inform them
  //       if (profile.user_type !== 'basic') {
  //         toast.success(
  //           `You’ll be downgraded to the free plan when your current subscription ends.`
  //         );
  //         return;
  //       }

  //       // If already on free/basic — update just in case
...
//       // If they're on a paid plan, cancel their subscription via webhook
//       if (profile.user_type !== 'basic' && profile.stripe_customer_id) {
//         try {
//           // Cancel active subscriptions directly via Stripe
//           const activeSubscriptions = await stripe.subscriptions.list({
//             customer: profile.stripe_customer_id,
//             status: 'active',
//           });
...
//           // Continue with the plan change even if cancellation fails
//         }
//       }
