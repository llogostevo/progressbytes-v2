      ...
      <div className="space-y-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-blue-700">Data Protection Act 2018</h2>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">1</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">2</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">3</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">4</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">5</div>
                  <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-red-700">Computer Misuse Act 1990</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="bg-red-100 text-red-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">1</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-red-100 text-red-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">2</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-red-100 text-red-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">3</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-red-100 text-red-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">4</div>
                  <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-purple-700">Copyright, Designs and Patents Act 1988</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-purple-100 text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">2</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-purple-100 text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">3</div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-purple-100 text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-0.5">4</div>
                  <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-green-700">Software Licences</h2>
          </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-green-700"><span className="font-medium">Source code available</span> - to everyone</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-600 mt-1">•</span>
                  <span className="text-green-700"><span className="font-medium">Freedom to modify</span> - anyone can use, change, and share</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-600 mt-1">•</span>
                  <span className="text-green-700"><span className="font-medium">Usually free</span> to use</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-600 mt-1">•</span>
                  <span className="text-green-700"><span className="font-medium">Examples:</span> Linux, LibreOffice, GIMP</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-600 mt-1">•</span>
                  <span className="text-green-700"><span className="font-medium">Great for</span> learning and collaboration</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 p-6 rounded-lg border border-red-200">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-red-700"><span className="font-medium">Source code secret</span> - kept private</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-red-600 mt-1">•</span>
                  <span className="text-red-700"><span className="font-medium">Limited modification</span> - only the company can change it</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-red-600 mt-1">•</span>
                  <span className="text-red-700"><span className="font-medium">Usually paid</span> - not free</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-red-600 mt-1">•</span>
                  <span className="text-red-700"><span className="font-medium">Examples:</span> Microsoft Office, Windows, Adobe Photoshop</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-red-600 mt-1">•</span>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-yellow-700">Recommending a Licence</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>For learning and educational purposes</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>When you want others to help improve the software</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>For sharing and collaboration</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-red-600 mt-1">✓</span>
                  <span>For making money and commercial use</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600 mt-1">✓</span>
                  <span>When you want to keep control of the code</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600 mt-1">✓</span>
                  <span>When you want to keep the code secret</span>
                </li>
              </ul>
            </div>
          </div>
