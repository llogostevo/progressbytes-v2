...
},
{
  ...
  model_answer: ["A value that is expected and within the valid range", "A value at the edge of the valid range", "A value that is invalid or outside the expected range"],
